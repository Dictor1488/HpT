...
```bat
python build.py --version 0.0.61
```
...
```text
build/me.agent.custom_hpbar_gameface_0.0.61.wotmod
```


## v0.0.61 event bindings
...
## FIXED archive
Default build scripts now use `0.0.61`, and Python contains the direct `FragCorrelationBar` hook.
